...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "gilclei@gmail.com", "36378912377",	TipoCliente.PESSOAFISICA,passwordEncoder.encode("123"));
		...
		Pagamento pagto3 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped3, sdf.parse("20/10/2017 00:00"),null);
		...
		ItemPedido ip4 = new ItemPedido(ped3, p2, 100.00, 2, 800.00);
